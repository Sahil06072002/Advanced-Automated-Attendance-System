...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"d:/Automated Attendance System/Main Window/Images_GUI/back.png")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame= Frame(self.root,bg="#F2F2F2")
        frame.place(x=10,y=50,width=850,height=580)
        

       # img1=Image.open(r"D:/Automated Attendance System/Main Window/Images_GUI/reg1.png")
       ...
       # lb1img1.place(x=300,y=100, width=500,height=100)
        ...
        loginbtn=Button(frame,command=self.reg,text="Register",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#000000",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=103,y=510,width=270,height=35)

        # Creating Button Login
        loginbtn=Button(frame,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#000000",activeforeground="white",activebackground="#007ACC")
